...
public class AdminHome extends AppCompatActivity implements SearchView.OnQueryTextListener, View.OnClickListener {
    int flag=0;
    ...
    Button button1,button2,button3,logout;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       /* ActionBar actionBar = getSupportActionBar();
        ...
        button1 = (Button)findViewById(R.id.buttonecu);
        button1.setOnClickListener(this::onClick);


        button2=(Button)findViewById(R.id.buttonstm);

        button2.setOnClickListener(this::onClick);

        button3=(Button)findViewById(R.id.buttonesp);
                                    ...
                                    new Thread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            if(uploadStatus==200)
                                            {
                                                runOnUiThread(new Runnable() {
                                                    public void run() {
                                                        AlertDialog dialog = new AlertDialog.Builder(AdminHome.this).setTitle("Finished" )
    ...
    public void onClick(View v) {
        ...
        {
            startActivity(new Intent(AdminHome.this, LandingPage.class));
        }
